...
public class PasswordEvaluator {
	...
	private static String passwordInput = "";			// The input being processed
	...
	public static String evaluatePassword(String input) {
		...
		if (foundOtherChar)
			errMessage += "No invalid character; ";
		
		if (errMessage == "")
			return "";
		
		passwordIndexofError = currentCharNdx;
		return "Password error: " + errMessage + "conditions were not satisfied";
